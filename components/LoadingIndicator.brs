...
sub mylog(msg as string)
	if m.enableLog then print "LoadingIndicator.brs - " ; msg
end sub
...
sub onBackgroundOpacityChange()
	mylog("[onBackgroundOpacityChange]")
...
sub onFadeAnimationStateChange()
	mylog("[onFadeAnimationStateChange]")
